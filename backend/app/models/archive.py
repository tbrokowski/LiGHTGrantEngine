...
from sqlalchemy import String, Float, Boolean, DateTime, Date, Text, JSON, ForeignKey, Integer, func
...
class GrantArchive(Base):
    ...
    # Graph clustering fields (populated by cluster_archives Celery task)
    embedding: Mapped[list | None] = mapped_column(Vector(1536), nullable=True)
    cluster_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("archive_clusters.id", ondelete="SET NULL"), nullable=True, index=True
    )
