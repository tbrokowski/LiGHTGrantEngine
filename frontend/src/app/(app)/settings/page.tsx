            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2 pt-5">
                ...
                <label htmlFor="high_priority" className="text-xs text-gray-600">
                  High priority <span className="text-gray-400">(included in daily scans)</span>
                </label>
              </div>
            </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide hidden lg:table-cell">Last scanned</th>
                ...
                sourceList.map(s => (
                  <tr key={s.id} className="hover:bg-gray-50">
                    <td className="px-5 py-3.5">
                      ...
                      {s.url && (
                        <div className="text-xs text-gray-400 mt-0.5 truncate max-w-xs">{s.url}</div>
                      )}
                      {s.category && (
                    ...
                    <td className="px-4 py-3.5 text-gray-500 hidden lg:table-cell text-xs">
                      {formatDate(s.last_checked) ?? 'Never'}
                      {s.opportunities_discovered != null && s.opportunities_discovered > 0 && (
                        <span className="ml-2 text-gray-400">· {s.opportunities_discovered} found</span>
                      )}
                    </td>
