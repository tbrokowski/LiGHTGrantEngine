...
export default function ArchiveLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!hasModulePermission(user, 'can_view_archive')) {
    return (
      <div className="px-8 py-16 text-center text-sm text-gray-500 max-w-md mx-auto">
        <p className="font-medium text-gray-800 mb-2">Archive module</p>
        <p>You do not have permission to access Archive. Ask an org admin to enable Archive under Settings → Members.</p>
